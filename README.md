...
2.  Clone the repository by running the following command:
        ...
        git clone https://github.com/oyieroyier/intro-to-html-and-css.git

3.  Change directory to the repo folder:

        cd intro-to-html-and-css
...
- Remember to replace your username when cloning.
      ...
      git clone https://github.com/your-github-username-here/intro-to-html-and-css.git
